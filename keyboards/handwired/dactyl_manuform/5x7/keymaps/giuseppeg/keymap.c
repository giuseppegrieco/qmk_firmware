...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
     * |  CTRL  |   A  |   S  |   D  | F:ALT|G:CTRL| TRO  |           | DEL  |H:CTRL|   J  |   K  |   L  |  ;   |   '    |
     * |--------+------+------+------+------+------|------'           `------|------+------+------+------+------+--------|
    ...
    [_QWERTY] = LAYOUT_5x7(
        ...
        // right hand
        KC_PGDN, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_RBRC, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_DEL, MT(MOD_RCTL, KC_H), KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, MT(MOD_RGUI, KC_N), KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_RBRC, KC_ESC, KC_ENT, KC_RGHT, KC_TAB, KC_LEFT),
    ...
    [_SYMBOLS] = LAYOUT_5x7(
        ...
        // right hand
        KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, KC_COLN, KC_BSLS, KC_7, KC_8, KC_9, KC_ASTR, _______, KC_AMPR, KC_GRV, KC_4, KC_5, KC_6, KC_PLUS, _______, KC_TILD, KC_1, KC_2, KC_3, KC_BSLS, _______, KC_MPLY, _______, KC_0, KC_MNXT, _______, KC_MINS, KC_RGUI, KC_DQUO, KC_QUOT, KC_EXLM),
};
